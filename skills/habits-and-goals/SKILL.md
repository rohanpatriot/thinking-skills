...
### Annual Planning
When planning your year, follow [templates/annual-plan.md](templates/annual-plan.md)

### Goal Decomposition
When breaking down a single Big Goal, follow [templates/goal-decomposition.md](templates/goal-decomposition.md)

### Monthly Check-in
When running a monthly review (last Friday of month), follow [templates/monthly-checkin.md](templates/monthly-checkin.md)

## Reference Guides

For detailed framework explanations:
- [Goal-Setting Framework](references/goal-setting-framework.md) - Big Goals, Checkpoints, Daily Systems, Anti-Goals
- [Execution Models](references/execution-models.md) - ABC System, Two-Day Rule, 30-for-30
